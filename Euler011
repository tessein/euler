	...
	public static void main(String[] args) {
		...
		for (int y = 0; y <= height - 4; y++)
			for (int x = 0; x <= width - 1; x++) {
				int linetotal = (matrix[y][x] * matrix[y + 1][x] 
		...
		for (int y = 0; y <= height - 1; y++)
			for (int x = 0; x <= width - 4; x++) {
				int linetotal = (matrix[y][x] * matrix[y][x + 1]
		...
		for (int y = 0; y <= height - 4; y++)
			for (int x = 0; x <= width - 4; x++) {
				int linetotal = (matrix[y][x] * matrix[y + 1][x + 1]
		...
		System.out.println("Euler011 = " + max + " - finished in "
